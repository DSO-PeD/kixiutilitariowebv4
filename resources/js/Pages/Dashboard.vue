                    ...
                    <div class="bg-white rounded-xl shadow p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        <h3 class="text-gray-500 text-sm font-medium uppercase tracking-wider">Nº De Reembolso
                                            Pendentes</h3>
                                        <p class="text-3xl font-bold mt-2 text-red-600">

                                          {{ $page.props.TotaldeRegistosdeReembolsosPendentes }}
                                            <span class="text-gray-500">/</span>
                                            {{ formatCurrency($page.props.TotalValordeReembolsosPendentes) }} Kz
