<template>
    <header
        class="sticky top-0 z-10 bg-gradient-to-r from-green-900 to-green-800 shadow-lg px-4 md:px-6 py-3 flex items-center justify-between transition-all duration-300">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative">
                <button @click="toggleNotifications"
                    class="relative p-2 text-green-200 hover:text-white hover:bg-green-800/50 rounded-lg transition-all duration-200">
                    ...
                    <span v-if="hasNotifications"
                        class="absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full border-2 border-green-900"></span>
                </button>
            ...
            <div class="relative" ref="dropdownRef">
                <button @click="toggleDropdown" class="flex items-center space-x-3 focus:outline-none group">
                    <div class="relative">
                        <div
                            class="w-10 h-10 bg-green-700 rounded-full flex items-center justify-center text-white font-semibold text-sm group-hover:bg-green-600 transition-colors duration-200">
                            {{ getUserInitials() }}
                        </div>
                        <div
                            class="absolute -bottom-1 -right-1 w-3 h-3 bg-green-400 rounded-full border-2 border-green-900">
                        </div>
                    </div>
                    ...
                    <svg class="w-4 h-4 text-green-300 transition-transform duration-200" fill="none"
                        stroke="currentColor" viewBox="0 0 24 24" :class="{ 'rotate-180': dropdownOpen }">
                ...
                <transition enter-active-class="transition ease-out duration-200"
                    ...
                    <div v-if="dropdownOpen"
                        class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl py-2 z-[9999] border border-gray-200"
        ...
        <Modal :show="showModalSMS" @close="showModalSMS = false">
            <div class="p-6">
                ...
                <p class="text-sm text-gray-600 text-center mb-6">Estará disponível em breve. Agradecemos sua
                    compreensão.</p>
