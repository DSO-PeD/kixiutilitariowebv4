    ...
    <div class="container mx-auto py-6 max-w-full">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
                ...
                <h1 class="text-2xl font-bold text-green-950"> <i class="fas fa-cash-register text-5xl  text-green-950"></i> &ThinSpace;&ThinSpace; Tesouraria </h1>
...
<hr class="py-2"/>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="(rec, index) in recuperacoesPaginados" :key="rec.id" class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-500">{{ rec.voucher }}</td>
                            <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{
        ...
        <!-- Modal para seleção data de pagamento -->
        <Modal :show="showMonthDialog" @close="showMonthDialog = false" maxWidth="md">
            <div class="bg-white p-6 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 mb-4">Selecionar a Data de Pagamento</h3>
...
const buscarPorLoan = () => {
    router.get('/tesouraria', { tipo: 3, loan: filtroLoan.value }, { preserveState: true })
...
const enviarConfirmacao = () => {
    ...
    Inertia.post('/confirmar-tesouraria', {
